...
public class JusticeHome extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                ...
                {
                    Intent intent =new Intent(JusticeHome.this,ShowPlaces.class);
                ...
                case  R.id.navigationMenu:
                    Intent a = new Intent(JusticeHome.this,Complaint.class);
                    startActivity(a);
                    return true;
            }
            return false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_justice_home);
...
//
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_profile) {
            ...
            changepinNumber.showChangePasswordDialog(JusticeHome.this);
    ...
    public void gotoReservRealState(View view) {
        Intent BookRealEstate=new Intent(this, BookRealEstate.class);
        startActivity(BookRealEstate);
    }

    public void gotoRealStateList(View view) {
        Intent BookRealEstate=new Intent(this, RealEstateReservationList.class);
        startActivity(BookRealEstate);
    }

    public void gotoPoliceReportList(View view) {
        Intent PoliceReportList=new Intent(this, PoliceReportList.class);
        startActivity(PoliceReportList);
    }
}

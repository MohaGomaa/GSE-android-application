...
public class TrafficViolationsAdapter extends RecyclerView.Adapter<TrafficViolationsAdapter.MyViewHolder> {

    private static Context mContext ;
    private static List<TrafficViolation> mData ;


    public TrafficViolationsAdapter(Context mContext, List<TrafficViolation> mData) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = inflater.inflate(R.layout.trafficviolations_item,parent,false) ;

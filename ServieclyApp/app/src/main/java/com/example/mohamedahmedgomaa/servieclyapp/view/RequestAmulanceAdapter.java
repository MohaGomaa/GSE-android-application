...
public class RequestAmulanceAdapter extends RecyclerView.Adapter<RequestAmulanceAdapter.MyViewHolder> {

    private static Context mContext ;
    private static List<RequestAmbulance> mData ;


    public RequestAmulanceAdapter(Context mContext, List<RequestAmbulance> mData) {

...
public class Reservation extends AppCompatActivity implements AdapterView.OnItemSelectedListener, MaterialSpinner.OnItemSelectedListener, AdapterView.OnItemClickListener {
    List<Reservation.StringWithTag> itemListCity;
    ArrayAdapter<Reservation.StringWithTag> spinnerAdapterCity;
    List<Reservation.StringWithTag> itemListServices;
    ArrayAdapter<Reservation.StringWithTag> spinnerAdapterServices;
    ...
    Map<String,String>mapGovernmentBody=null;
   ...
   String service,state,city,region,district,office,serv="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgressDialog=new ProgressDialog(Reservation.this);
        ...
        //state = spStat.getSelectedIndex();
        //Toast.makeText(this,""+spStat.getSelectedItem(),Toast.LENGTH_SHORT).show();
...
*/
        ...
        */
        ...
        etDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog =  new DatePickerDialog(Reservation.this, date, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH), myCalendar.get(Calendar.DAY_OF_MONTH));
    ...
    public void SendReserve(View view) {
        ...
        if(spOffice.getSelectedIndex()==0)
        {
        ...
        if (spServices.getSelectedIndex()==0)
        {
            spServices.setError( getString(R.string.Selectoffice));
            return;
        }
        else
        {
            spServices.setError(null);
        }
      showDialog();
    }
    ...
    {new TTFancyGifDialog.Builder(Reservation.this)
            .setTitle(getString(R.string.ReserveCivilRegistryAppointment))
            ...
            .OnPositiveClicked(new TTFancyGifDialogListener() {
                ...
                public void OnClick() {
                    ...
                    MySingleton.getInstance(Reservation.this).addToRequestQueue(stringRequest);
    ...
    public void jsonParsingService(String response){
        ...
        try {
            ...
            itemListServices = new ArrayList<Reservation.StringWithTag>();
            itemListServices.add(new Reservation.StringWithTag(" ", " "));
            ...
            for (Map.Entry<String, String> entry : mapServices.entrySet()) {
                ...
                /* Build the StringWithTag List using these keys and values. */
                itemListServices.add(new Reservation.StringWithTag(value, key));
            }

            spinnerAdapterServices = new ArrayAdapter<Reservation.StringWithTag>(this, android.R.layout.simple_spinner_item, itemListServices);
            spinnerAdapterServices.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            spServices.setAdapter(spinnerAdapterServices);
            final String[] loadsearchkeyID = new String[1];
            spServices.setOnItemSelectedListener(this);
...
// office Spinner and parsing data
    public  void getOfficeSpinner() {
        mProgressDialog.show();
        String url="http://192.168.1.34:88/api/Offices?DId="+dsId+"&GovId="+Govid;
        StringRequest stringRequest1=new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                //Toast.makeText(getApplicationContext(),"Error :"+response,Toast.LENGTH_LONG).show();
    ...
    public void jsonParsing(String response){
        ...
        try {
            ...
            for (int i=0; i<jsonRoot.length(); i++ ){
             ...
             itemListOffice = new ArrayList<StringWithTag>();
            itemListOffice.add(new StringWithTag(" ", " "));
            ...
            for (Map.Entry<String, String> entry : mapOffice.entrySet()) {
                ...
                /* Build the StringWithTag List using these keys and values. */
                itemListOffice.add(new StringWithTag(value, key));
            }

           spinnerAdapterOffice = new ArrayAdapter<StringWithTag>(this, android.R.layout.simple_spinner_item, itemListOffice);
    ...
    public void onItemSelected(MaterialSpinner view, int position, long id, Object item) {
        ...
        if(view==spGovernmentBody)
        {
            ...
            if(itemListServices!=null) {
                itemListServices = null;

                spServices.setAdapter(arrayAdapter);
            }

...
public class PoliceReportAdapter extends RecyclerView.Adapter<PoliceReportAdapter.MyViewHolder> {

    private static Context mContext ;
    private static List<PoliceReport> mData ;


    public PoliceReportAdapter(Context mContext, List<PoliceReport> mData) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = inflater.inflate(R.layout.police_report_item,parent,false) ;
